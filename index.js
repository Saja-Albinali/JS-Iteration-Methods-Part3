...
******************************************************************/
const graterThanOrEqual = temperatures.filter(
  (tempreature) => tempreature >= 25
);
console.log(graterThanOrEqual);

const lessThanOrEqual = temperatures.filter((tempreature) => tempreature <= 20);
...
******************************************************************/
const tempInFahrenheit = temperatures.map(
  (tempreature) => (tempreature * 9) / 5 + 32
);
console.log(tempInFahrenheit);

const tempcondition = temperatures.map((tempreature) => {
  if (tempreature >= 25) return "warm";
  else if (tempreature >= 20) return "mild";
  else return "cool";
});
...
const lowestTemp = temperatures.reduce(
